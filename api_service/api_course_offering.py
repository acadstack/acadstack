...
async def course_offering_view(my_id):
    try:
        ...
        msg = "Error when fetching CourseOffering details."
...
async def course_offering_find():
    try:
        ...
        msg = "Error when finding course offerings."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
def _do_course_offering_lookup(query_str, all_statuses):
    try:
        ...
        msg = "Error when looking up course offerings."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
async def offerings_of_course(my_id):
    try:
        ...
        msg = "Error when getting offerings of a course."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
async def get_running_courses():
    try:
        ...
        msg = "Error occurred when fetching running courses."
        logging.exception(msg)
        return apiVC.error_json(msg)