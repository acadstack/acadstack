...
def get_feedback_forms():
    try:
        ...
        msg = "Error when getting feedback forms."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
def load_feedback_form(form_id):
    try:
        ...
        msg = "Error when loading feedback form."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
def get_active_feedback_form(form_type):
    try:
        ...
        msg = "Error when loading active feedback form."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
def student_enrolments_for_fb(form_type):
    try:
        ...
        msg = "Error when loading student's current enrolments."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
async def save_course_instructor_feedback():
    try:
        ...
        msg = "Error when saving instructor feedback."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
async def get_instructor_feedback(co_id, user_id, fb_type):
    try:
        ...
        msg = "Error when fetching instructor feedback data."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
async def download_feedback_stats(form_type, acad_session):
    try:
        ...
        msg = "Error when loading fetching Feedback as CSV."
        logging.exception(msg)
        return apiVC.error_json(msg)
...
async def download_quewise_facfeedbk_score(form_type, acad_session):
    try:
        ...
        msg = "Error when Downloading Questions Wise Faculty Feedback as CSV."
        logging.exception(msg)
        return apiVC.error_json(msg)